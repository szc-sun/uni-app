...
Z(z[1])
Z([3,'__e'])
Z([[4],[[5],[[2,'+'],[1,'footer_item '],[[2,'?:'],[[2,'=='],[[6],[[7],[3,'item']],[3,'size']],[1,'big']],[1,'big_item'],[1,'']]]]])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'change_nav']],[[4],[[5],[[7],[3,'index']]]]]]]]]]]])
Z([[2,'+'],[1,'width:'],[[7],[3,'item_width']]])
...
var x=['./components/footer/footer_nav.wxml','./components/uni-icon/uni-icon.wxml','./components/uni-nav-bar/uni-nav-bar.wxml','./components/uni-status-bar/uni-status-bar.wxml','./pages/index/index.wxml','./pages/index/pages/cart/cart.wxml','./pages/index/pages/center/center.wxml','./pages/index/pages/home/home.wxml','./pages/index/pages/message/message.wxml','./pages/test/index.wxml'];d_[x[0]]={}
...
var oJ=_mz(z,'view',['bindtap',5,'class',1,'data-event-opts',2,'style',3],[],hG,cF,gg)
var lK=_mz(z,'image',['mode',-1,'src',9],[],hG,cF,gg)
_(oJ,lK)
var aL=_n('view')
...
var fS=_mz(z,'uni-status-bar',['bind:__l',3,'vueId',1],[],e,s,gg)
_(oR,fS)
}
var cT=_mz(z,'view',['class',5,'style',1],[],e,s,gg)
var hU=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2],[],e,s,gg)
var oV=_v()
_(hU,oV)
if(_oz(z,10,e,s,gg)){oV.wxVkey=1
var oX=_n('view')
var lY=_mz(z,'uni-icon',['bind:__l',11,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(oX,lY)
_(oV,oX)
}
var cW=_v()
...
var cAB=_n('view')
var oBB=_mz(z,'uni-icon',['bind:__l',28,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(cAB,oBB)
_(h9,cAB)
}
var o0=_v()
...
_(hMB,oNB)
_(cLB,hMB)
var cOB=_mz(z,'button',['bindtap',6,'data-event-opts',1],[],e,s,gg)
var oPB=_oz(z,8,e,s,gg)
_(cOB,oPB)
_(cLB,cOB)
var lQB=_mz(z,'label',['class',9,'hidden',1],[],e,s,gg)
var aRB=_oz(z,11,e,s,gg)
_(lQB,aRB)
_(cLB,lQB)
_(oJB,cLB)
var tSB=_mz(z,'footer-nav',['bind:__l',12,'vueId',1],[],e,s,gg)
_(oJB,tSB)
_(r,oJB)
return r
}
...
var oBC=_mz(z,'uni-nav-bar',['bind:__l',1,'bind:clickLeft',1,'data-event-opts',2,'leftIcon',3,'leftText',4,'rightText',5,'title',6,'vueId',7],[],e,s,gg)
_(xAC,oBC)
var fCC=_n('view')
...
__wxAppCode__['pages/index/pages/cart/cart.wxss']=undefined;    
__wxAppCode__['pages/index/pages/cart/cart.wxml']=$gwx('./pages/index/pages/cart/cart.wxml');

__wxAppCode__['pages/index/pages/center/center.wxss']=undefined;    
__wxAppCode__['pages/index/pages/center/center.wxml']=$gwx('./pages/index/pages/center/center.wxml');

__wxAppCode__['pages/index/pages/home/home.wxss']=undefined;    
__wxAppCode__['pages/index/pages/home/home.wxml']=$gwx('./pages/index/pages/home/home.wxml');

__wxAppCode__['pages/index/pages/message/message.wxss']=undefined;    
__wxAppCode__['pages/index/pages/message/message.wxml']=$gwx('./pages/index/pages/message/message.wxml');

__wxAppCode__['pages/test/index.wxss']=undefined;    
